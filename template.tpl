    ...
    "subParams": [
      {
        ...
        "checkboxText": "Enable e-commerce",
        "simpleValueType": true
      },
      {
        "type": "SELECT",
  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "enablingConditions": [
          {
            "paramName": "contentTrackingEnabled",
            "paramValue": true,
            "type": "EQUALS"
          }
        ],
...
function getMatomoQueryParams() {
  ...
  if(data.contentTrackingEnabled) {
